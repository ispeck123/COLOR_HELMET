...
export RTSP_URL=output.webm # Video source, webcam, rtsp or network feed
...
export ROI=[[234,312],[542,275],[947,366],[1274,435],[1275,714],[1015,716],[674,559],[297,405]] # Require co-ordinated in a list format, blank if there is no ROI
export MODEL_CONF=0.5 # Model Confidence on detection, below this neglects detection.
export TIME_ZONE='Asia/Singapore' 
export NON_COMPLIANCE_HELMET_COLOR='WHITE' # 'WHITE', 'YELLOW', 'RED' , 'BLUE' , 'GREEN' , 'GRAY'
